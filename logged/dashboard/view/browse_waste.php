...
<body class="">
  ...
  top: 0;background:white">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Buy</a>
          </div>
...
//$result = mysqli_query($db, "SELECT * FROM entries order by e_id desc");
              ...
              <div class="col-md-12">
                <div class="card ">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <h4 class="card-title">Reusable Items</h4>
                  </div>
                    <?php 
                   ...
                   /* $result_member = mysqli_query($db1, "SELECT * FROM entries where username ='".$displayName."'");*/
                    $result_entry = mysqli_query($db,"Select * from sell_item order by itm_id desc");
